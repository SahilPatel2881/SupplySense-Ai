        ...
        <main className="flex-1 overflow-y-auto p-6 space-y-6 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs">
            <div>
              ...
              <p className="text-slate-500 text-xs mt-1">Manage stock in/out operations, inter-warehouse transfers, optical barcode scans, and movement logs.</p>
            </div>
